...
async function runTest() {
  console.log('Iniciando Puppeteer conectándose a puerto 9222 (Instancia MCP)...');
  ...
  console.log('\nCerrando pestaña...');
  await page.close();
  console.log('¡Todas las pruebas mediante la instancia depurable (puerto 9222) se completaron y los screenshots fueron actualizados!');
}
