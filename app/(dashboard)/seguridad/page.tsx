      ...
      <Card>
        ...
        {controls.length === 0 ? (
          <div className="mt-4 rounded-2xl border border-[var(--color-warning-border)] bg-[var(--color-warning-soft)] p-4">
            <p className="text-sm font-semibold text-[var(--color-warning-strong)]">No hay controles configurados.</p>
            <p className="mt-1 text-sm text-[var(--color-text-secondary)]">
              Aplica la migración <code className="rounded bg-[var(--color-surface)] px-1">20260513130000_security_controls_y_servicios_especiales_tarifa.sql</code> en
              Supabase o revisa RLS y permisos.
            </p>
          </div>
        ) : null}
